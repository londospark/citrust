...
";
        ...
        assert_eq!(db.len(), 3);
        assert_eq!(db.generator(), Some(0x00000000000000000000000000000000u128));
        assert_eq!(
            db.get_key_x(0x2C),
            Some(0x00000000000000000000000000000000u128)
        );
        assert_eq!(
            db.get_key_x(0x25),
            Some(0x00000000000000000000000000000000u128)
...
";
    ...
    fn test_parse_with_bom() {
        let input = "\u{FEFF}generator=00000000000000000000000000000000\n";
        let db = parse(input).unwrap();
        assert_eq!(db.len(), 1);
...
";
    ...
    fn test_missing_key_returns_none() {
        let input = "generator=00000000000000000000000000000000\n";
        let db = parse(input).unwrap();
